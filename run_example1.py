...
file_handle=open('whj_code2/integration_experiment/run_example1_output.out',
                mode='a')  #追加
file_handle.write('我发现我有bug，我死了，我重跑一遍，lr0.01+epoch300+10，无向图:\n')
"""
        ...
        try:
            for seed in seeds:  #遍历seed_number个数据集划分
                acc_dict=experiment(model_init_param=InitialParameters.default_init_params[i],
                                    ...
                                    print_pics=True,pics_name='di_'+d['dataset_name']+InitialParameters.model_names[i]+'.png',
                                    vis_feat=True,feat_pic_names_prefix='di_'+d['dataset_name']+InitialParameters.model_names[i],
